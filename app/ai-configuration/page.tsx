...
import { ArrowLeft, Brain, Settings, CheckCircle, Plus, Edit, Trash2, Save, RefreshCw } from "lucide-react"
import { AddExtractionRuleModal } from "@/components/add-extraction-rule-modal"
...
export default function AIConfiguration() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          <div className="flex items-center space-x-4 mt-1">
                            <p className="text-xs text-gray-500">Pattern: {rule.pattern}</p>
                            <Badge variant="outline" className="text-xs">
                              {auditAreas.find((area) => area.id === rule.auditArea)?.name}
                            </Badge>
      ...
      {/* Add Extraction Rule Modal */}
      <AddExtractionRuleModal
